...
#define SMARTRF_SETTING_FSCTRL1          0x0A //frequency synthesizer control  
#define SMARTRF_SETTING_FSCTRL0          0x00 //frequency synthesizer control  
#define SMARTRF_SETTING_FREQ2            0x5D //frequency control word, high byte  
#define SMARTRF_SETTING_FREQ1            0x93 //frequency control word, middle byte  
#define SMARTRF_SETTING_FREQ0            0xB1 //frequency control word, low byte  
#define SMARTRF_SETTING_MDMCFG4          0x2D //modem configuration  
#define SMARTRF_SETTING_MDMCFG3          0x3B //modem configuration  
#define SMARTRF_SETTING_MDMCFG2          0x73 //modem configuration 
...
#define SMARTRF_SETTING_AGCCTRL1         0x00 //agc control 
